            ...
            <div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 20, marginBottom: 28 }}>
                {[
                  ...
                  { plan: "Paid Members (Bloom / Flourish)", color: T.orange, icon: "🌸", pts: ["6 auto + 6 browse matches per month", "Browse by asset type, feedback format, plan, and availability", "1–3° separation supported (in-app settings UI in development)", "If browsing to a Free member at their limit, match queues to next month — no credits lost for either party", "Semi-duplicate re-matches supported, with prior channels automatically blocked on both sides"] }
                ...
                <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
                  ...
                  <div>
                    ...
                    {[
                      ...
                      { n: 4, title: "Semi-duplicate defaults for Paid members", desc: "Semi-duplicate matching is ON (allowed) by default and enforced by the system, including the option to allow or block re-matches with Free members. In-app controls for these settings are in development." },
                    ].map(({ n, title, desc }) => (
