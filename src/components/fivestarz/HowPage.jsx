        ...
        <div style={{ maxWidth: 900, margin: "0 auto", padding: isMobile ? "32px 16px" : "48px 32px" }}>
            ...
            <div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 20, marginBottom: 28 }}>
                {[
                  ...
                  { plan: "Paid Members (Bloom / Flourish)", color: T.orange, icon: "🌸", pts: ["6 auto + 6 browse matches per month", "Browse by asset type, feedback format, plan, and availability", "Set separation 1–3° in Account → Matching preferences", "If browsing to a Free member at their limit, match queues to next month — no credits lost for either party", "Can disable semi-duplicate matching, or allow it only with other paid members, in Matching preferences"] }
                ...
                <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
                  ...
                  <div>
                    ...
                    {[
                      ...
                      { n: 4, title: "Paid members control their semi-duplicate settings", desc: "Paid members can disable semi-duplicate matching entirely, or specifically block it only for Free members. The default is ON (allowed). These toggles live in Account → Matching preferences." },
                    ].map(({ n, title, desc }) => (
          ...
          {tab === "roadmap" && (
            <div>
              ...
              {[
                { phase: "✅ Live in Beta", color: T.green, bg: T.greenP, items: [{ t: "Auto-matching (Free & Paid)", d: "Category-aware pairing with duplicate prevention and degrees-of-separation filtering." }, { t: "Browse & Request (Paid)", d: "Browse members with filters: asset type, feedback format, plan, and availability." }, { t: "Multi-asset support", d: "Paid members can create multiple assets — services, products, content, and advisory skills." }, { t: "Advisory Skills asset type", d: "Paid members list consulting expertise as an asset. Peer members experience and give honest internal feedback on knowledge and value delivered." }, { t: "Feedback form builder", d: "Asset owners control which feedback formats (written, structured categories, video) are allowed or required." }, { t: "Optional public sharing", d: "After feedback is submitted, asset owners may optionally ask if the reviewer would like to share their experience publicly. Reviewers are never obligated or incentivized." }, { t: "Client asset management", d: "Paid members manage assets on behalf of clients and coordinate their feedback collection." }, { t: "Semi-duplicate prefs for Paid members", d: "Toggle semi-duplicate matching on/off; optionally block it only for Free members. Default: ON. In Account → Matching preferences." }, { t: "Degrees of separation settings", d: "In-app control for Paid members to adjust separation (1–3°) with trade-off explanations shown." }, { t: "Feedback status pipeline", d: "Every match card shows its progress: matched → your feedback → their feedback → post requested → posted." }, { t: "AI asset drafting", d: "Paste your URL when adding an asset and AI drafts the name, description, type, channels, and feedback formats — you review and edit everything." }] },
                { phase: "🔨 In Development", color: T.orange, bg: T.orangeP, items: [{ t: "Semi-duplicate matching — Free ↔ Free", d: "When two Free members have new available channels from their last match, they can be re-matched with prior channels automatically blocked on both sides." }] },
                { phase: "🗓️ Planned", color: T.teal, bg: T.tealP, items: [{ t: "Team accounts (Flourish)", d: "Multiple seats under one plan for agencies and teams." }, { t: "White-label feedback forms", d: "Embed branded forms on your site that route into FiveStarz." }, { t: "Video review support", d: "Record and submit short video testimonials — higher-trust, higher-impact." }, { t: "Review performance analytics", d: "Track channel performance, asset feedback, and overall reputation score." }] },
                { phase: "💡 Under Consideration", color: T.purple, bg: T.purpleP, items: [{ t: "Match history & network graph", d: "Visual representation of your review network as it grows over time." }, { t: "Community trust score", d: "Member reputation based on feedback quality, completion rates, and community standing." }, { t: "Niche communities", d: "Sub-communities for specific verticals (SaaS, food & bev, creative services) with tailored matching." }, { t: "API & Zapier integration", d: "Connect your CRM to auto-kick off review collection when a project closes." }] },
