    ...
    <div style={{ background: T.cream }}>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", padding: isMobile ? "32px 16px" : "48px 32px" }}>
          ...
          {tab === "roadmap" && (
            <div>
              ...
              {[
                { phase: "✅ Live in Beta", color: T.green, bg: T.greenP, items: [{ t: "Auto-matching (Free & Paid)", d: "Category-aware pairing with duplicate prevention and degrees-of-separation filtering." }, { t: "Browse & Request (Paid)", d: "Browse members with filters: asset type, channel, feedback format, plan, and credit availability." }, { t: "Multi-asset support", d: "Paid members can create multiple assets — services, products, content, and advisory skills." }, { t: "Advisory Skills asset type", d: "Paid members list consulting expertise as an asset. Peer members review the knowledge and value delivered." }, { t: "Feedback form builder", d: "Asset owners control which feedback formats (stars, text, categories, video) are allowed or required." }, { t: "Request-to-post flow", d: "Asset owners ask reviewers to post to a chosen channel. Reviewers are never obligated." }, { t: "Client asset management", d: "Paid members manage assets on behalf of clients and coordinate their review collection." }] },
      ...
      <section style={{ padding: "60px 32px", textAlign: "center", background: T.cream }}>
        <div style={{ maxWidth: 500, margin: "0 auto" }}>
          <h2 style={{ fontFamily: "'Fraunces',serif", fontSize: 36, fontWeight: 800, color: T.brown, margin: "0 0 16px" }}>Ready to earn your stars?</h2>
          <p style={{ fontSize: 16, color: T.slate, fontFamily: "'DM Sans',sans-serif", marginBottom: 28 }}>Join the beta and start building real social proof.</p>
