    ...
    <div style={{ background: T.cream }}>
      ...
      <section style={{ padding: "64px 32px", background: T.brown, textAlign: "center" }}>
        <div style={{ maxWidth: 520, margin: "0 auto" }}>
          ...
          <p style={{ color: "#C4A68A", fontSize: 16, lineHeight: 1.65, fontFamily: "'DM Sans',sans-serif", marginBottom: 32 }}>Human feedback only. No games, no swaps, no manipulation.</p>
