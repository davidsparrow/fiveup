  ...
  return (
    <main style={styles.page}>
      <section style={styles.card}>
        ...
        <p style={styles.subtitle}>This signs you up against your Supabase project so you can test real auth.</p>
        ...
        <form action={signUp} style={styles.form}>
          ...
          <label style={styles.label}>
            Name
            <input name="name" type="text" autoComplete="name" style={styles.input} />
          </label>
          <label style={styles.label}>
            Email
          ...
          <label style={styles.label}>
            Password
            <input name="password" type="password" required minLength={6} autoComplete="new-password" style={styles.input} />
          </label>
        ...
        <p style={styles.footerText}>
          Already have an account? <Link href="/login" style={styles.inlineLink}>Log in</Link>.
        </p>
      </section>
    </main>
  );
...
const styles = {
  page: {
    ...
    padding: "32px 16px",
    background: "linear-gradient(160deg,#fff8f0 0%,#fff3e4 50%,#ffe8d6 100%)",
  },
  card: {
    width: "100%",
    maxWidth: 460,
